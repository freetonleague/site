(() => {
  ...
  var require_scrollspy = __commonJS((exports) => {
    __export(exports, {
      ScrollSpy: () => ScrollSpy
    });
    class ScrollSpy {
  ...
  var require_src = __commonJS((exports, module) => {
    module.exports = (el, options = {}) => {
      const {ScrollSpy} = require_scrollspy();
  ...
  var require_animated_scroll_to = __commonJS((exports) => {
    "use strict";
    ...
    if (WINDOW_EXISTS) {
      window.animateScrollTo = animateScrollTo2;
    }
  });
  ...
  // src/js/app/nav.js
  const simple_scrollspy = __toModule(require_src());
  const animated_scroll_to = __toModule(require_animated_scroll_to());
  class Nav {
    constructor(el) {
      this.nav = el;
      this.navToggle = document.querySelector(".js-nav-toggle");
      this.navMenu = this.nav.querySelector(".js-nav-menu");
      this.navLink = this.nav.querySelectorAll(".js-nav-link");
      this.scrollTopLink = document.querySelector(".js-scroll-top");
      this.body = document.querySelector("body");
      this.isMobile = document.documentElement.clientWidth < 768;
      this.init();
    }
    init() {
      this.scrollSpyFunction();
      this.setListeners();
    }
    setListeners() {
      this.navToggle.addEventListener("click", this.toggleNav.bind(this));
      this.scrollTopLink.addEventListener("click", this.smoothScroll.bind(this));
      this.navLink.forEach((el) => {
        el.addEventListener("click", this.smoothScroll.bind(this));
      });
    }
    toggleNav() {
    ...
    scrollSpyFunction() {
      ...
      simple_scrollspy.default(this.navMenu, options);
    }
    smoothScroll(link) {
      let targetId = link.target.getAttribute("href");
      if (this.isMobile)
        this.toggleNav();
      animated_scroll_to.default(document.querySelector(targetId));
      return false;
    }
  }
  ...
  class Slider {
    constructor(el) {
      ...
      this.slider = null;
      if (this.sliderType == "news" || this.sliderType == "stories" || this.sliderType == "tournament") {
